...
1. Fork `the repository <https://github.com/augmentedfabricationlab/climate_active_envelopes>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/climate_active_envelopes/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/climate_active_envelopes/issues>`_. If you are proposing a feature:
